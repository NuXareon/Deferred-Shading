...
#define GRID_RES				32.0
#define LIGHT_PROX_RATIO		4.0
#define LIGHT_PATH				"lights.csv"

enum renderModeType {RENDER_POSITION, RENDER_NORMAL, RENDER_DIFFUSE, RENDER_ALL, RENDER_FORWARD, RENDER_FORWARD_BLEND, RENDER_DEPTH, RENDER_DEFERRED, RENDER_GRID};
